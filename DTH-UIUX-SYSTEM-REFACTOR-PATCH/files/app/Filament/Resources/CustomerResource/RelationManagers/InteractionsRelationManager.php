    ...
    public function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('interaction_at')->label(__('field.interaction_at'))->dateTime('d/m/Y H:i'),
                TextColumn::make('next_follow_up_at')->label(__('field.next_follow_up'))->dateTime('d/m/Y H:i'),
            ])
