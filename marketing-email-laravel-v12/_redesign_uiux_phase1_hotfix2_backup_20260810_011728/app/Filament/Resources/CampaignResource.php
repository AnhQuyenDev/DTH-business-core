        ...
        return $form->schema([
            Section::make(__('section.campaign_details'))
                ...
                ->schema([
                    ...
                    TextInput::make('subject')->label(__('field.subject'))->required()->maxLength(255)->columnSpanFull(),
                    TextInput::make('preheader')->label(__('field.preheader'))->maxLength(255)->columnSpanFull(),
            ...
            Section::make(__('uiux.section.audience'))
                ->columns(['default' => 1, 'md' => 2])
                ->schema([
                    ...
                    Select::make('landing_page_id')
                        ...
                        ->visible(fn (Get $get): bool => $get('audience_type') === 'qualified'),
                ]),
            Section::make(__('uiux.section.delivery'))
                ->columns(['default' => 1, 'md' => 2])
                ->schema([
                    DateTimePicker::make('scheduled_at')
                        ->label(__('field.scheduled_at'))
                        ->seconds(false),
                ]),
        ]);
    }
