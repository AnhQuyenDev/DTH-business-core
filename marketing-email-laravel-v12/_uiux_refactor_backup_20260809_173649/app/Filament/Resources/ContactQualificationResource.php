        ...
        return $table->columns([
            ...
            TextColumn::make('status')
                ...
                ->color(function ($state): string {
                    $value = $state instanceof ContactQualificationStatus
                        ? $state->value
                        : (string) $state;
            ...
            TextColumn::make('qualification_result')
                ...
                ->color(function ($state): string {
                    $value = $state instanceof QualificationResult
                        ? $state->value
                        : (string) $state;
                    ...
                    return match ($normalized) {
                        'confirmed_need', 'purchased' => 'success',
                        'no_need', 'unreachable', 'invalid_information' => 'danger',
                        default => 'gray',
                    };
                }),
