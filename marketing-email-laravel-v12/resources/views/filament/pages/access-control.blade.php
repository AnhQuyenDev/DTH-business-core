<x-filament-panels::page>
    <div class="dth-config-shell">
        <div class="dth-config-toolbar">
            <p>{{ __('configuration.access.description') }}</p>
            @if (count($attention))
                ...
                @if ($card['visible'])
                    <a href="{{ $card['url'] }}" class="dth-config-launch-card">
                        ...
                        <span class="dth-config-launch-card__content">
                            <strong>{{ __('configuration.access.cards.'.$key.'.title') }}</strong>
                            <span>{{ __('configuration.access.cards.'.$key.'.description') }}</span>
                        </span>
