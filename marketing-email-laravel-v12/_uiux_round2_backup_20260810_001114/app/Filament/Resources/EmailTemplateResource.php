...
class EmailTemplateResource extends Resource
{
    ...
    {
        return $form->schema([
            Section::make(__('section.email_template_identity'))
                ->description(__('helper.email_template_identity'))
                ->columns(2)
                ->schema([
                    TextInput::make('name')
                        ->label(__('field.name'))
            ...
            Section::make(__('section.email_template_content'))
                ->description(__('helper.email_template_content'))
                ->schema([
                    RichEditor::make('html_body')
                        ->label(__('field.html_body'))
                        ->required()
                        ->columnSpanFull(),
                    Textarea::make('text_body')
                        ->label(__('field.text_body'))
                        ->rows(6)
                        ->columnSpanFull(),
                ]),
        ]);
