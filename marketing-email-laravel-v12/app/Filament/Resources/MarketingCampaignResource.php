    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Select::make('service_ids')
                ...
                ->helperText(
                    'Campaign trả lời câu hỏi “Chiến dịch này đang quảng bá dịch vụ gì?”. '
                    .'Có thể chọn nhiều dịch vụ, ví dụ Web Hosting + VPS.'
                ),
            ...
            Select::make('landing_page_ids')
                ...
                ->helperText(
                    'Chỉ Landing Page có Dịch vụ chính nằm trong phạm vi Campaign '
                    .'mới được chọn. Một Landing Page không được tự động chuyển khỏi '
                    .'Campaign khác.'
                ),
            Textarea::make('notes')
                ->label(__('field.note'))
