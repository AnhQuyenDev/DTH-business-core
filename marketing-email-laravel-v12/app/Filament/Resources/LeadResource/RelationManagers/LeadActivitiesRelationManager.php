        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('status')
                    ...
                    ->color(fn (LeadActivityStatus $state): string => match ($state) {
                        LeadActivityStatus::Planned => 'warning',
                        LeadActivityStatus::Completed => 'success',
                        LeadActivityStatus::Cancelled => 'gray',
                    }),
