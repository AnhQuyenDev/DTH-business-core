...
{
    protected $fillable = [
        'payment_id', 'quotation_item_id', 'service_id', 'service_package_id', 'service_product_id',
        'service_code_snapshot', 'service_name_snapshot', 'package_code_snapshot',
        'package_name_snapshot', 'product_name_snapshot', 'quantity', 'net_amount', 'tax_amount', 'gross_amount',
    ];
