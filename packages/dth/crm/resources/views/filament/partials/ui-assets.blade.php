...
<style>
    ...
    html body .fi-btn.dth-crm-form-action--primary {
    ...
    html body .fi-btn.dth-crm-form-action--primary * { color: #ffffff !important; }
    html body .fi-btn.dth-crm-form-action--primary:hover {
        background: linear-gradient(180deg, #0f766e 0%, #0b655e 100%) !important;
        border-color: #0b655e !important;
        transform: translateY(-1px);
    }

    html body .fi-btn.dth-crm-form-action--secondary {
        min-height: 42px !important;
        padding: 0 16px !important;
        border: 1px solid var(--dth-crm-border) !important;
        border-radius: 12px !important;
        background: #fff !important;
        color: var(--dth-crm-text) !important;
        box-shadow: none !important;
        font-weight: 720 !important;
        gap: .45rem !important;
    }
    html body .fi-btn.dth-crm-form-action--secondary * { color: var(--dth-crm-text) !important; }
    html body .fi-btn.dth-crm-form-action--secondary:hover {
