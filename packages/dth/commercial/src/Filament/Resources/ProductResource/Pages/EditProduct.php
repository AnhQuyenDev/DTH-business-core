...
class EditProduct extends EditRecord
{
    ...
    {
        return PageHeading::make(UiText::get('pages.products.edit_title', 'Edit product'), ProductResource::NAVIGATION_ICON);
    }

    public function getSubheading(): string|Htmlable|null
    {
        return UiText::get('pages.products.edit_subheading', 'Update product information and price-list entries without changing historical opportunity snapshots.');
    }
