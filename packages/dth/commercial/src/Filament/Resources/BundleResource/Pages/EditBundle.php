...
class EditBundle extends EditRecord
{
    ...
    {
        return PageHeading::make(UiText::get('pages.packages.edit_title', 'Edit service bundle'), BundleResource::NAVIGATION_ICON);
    }

    public function getSubheading(): string|Htmlable|null
    {
        return UiText::get('pages.packages.edit_subheading', 'Update bundle components and pricing without changing historical opportunity line-item snapshots.');
    }
