...
class LandingPageResource extends Resource
{
                        ...
                        ->afterStateUpdated(function ($state, Set $set, Get $get): void {
                            ...
                            try {
                                ...
                                foreach ($import['embedded_forms'] as $index => $embeddedForm) {
                                    ...
                                    // as Draft. Rendering appends selected forms at the end of the page;
                                    // Publish still requires the attached template to be Active.
                                    if ($sequence === 1) {
                                        $set(
            ...
            ->recordActions([
                ...
                Actions\Action::make('generate_utm')
                    ...
                    ->action(function (LandingPage $record, array $data): void {
                        $url = app(LandingPageUtmBuilder::class)->build($record, $data);
                ...
                Actions\EditAction::make()
                    ...
                    ->visible(fn (LandingPage $record): bool => $record->status === LandingPageStatus::Draft),
    ...
    {
        return $record instanceof LandingPage
