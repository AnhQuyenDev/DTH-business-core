...
class MarketingCampaignResource extends Resource
{
        ...
        return $table
            ...
            ->recordActions([
                Actions\EditAction::make()
                    ...
                    ->visible(fn (MarketingCampaign $record): bool => ! $record->isTerminal()),
                ...
                Actions\DeleteAction::make()
                    ...
                    ->visible(fn (MarketingCampaign $record): bool => $record->status === MarketingCampaignStatus::Draft),
            ])
            ->bulkActions([
    ...
    private static function transitionAction(
        ...
        $action = Actions\Action::make($name)
            ...
            ->icon($icon)
            ->color($color)
            ->visible(fn (MarketingCampaign $record): bool => in_array(
                $target,
    ...
    {
        return $record instanceof MarketingCampaign && ! $record->isTerminal();
    }

    public static function canDelete(Model $record): bool
    {
        return $record instanceof MarketingCampaign
