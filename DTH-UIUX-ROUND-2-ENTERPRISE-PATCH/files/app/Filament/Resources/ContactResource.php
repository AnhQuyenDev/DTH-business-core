...
class ContactResource extends Resource
{
    ...
    {
        return $form->schema([
            Select::make('contact_type')->label(__('field.contact_type'))->options([
                'personal' => __('enum.contact_type.personal'),
                'business' => __('enum.contact_type.business'),
            ])->required(),
            Select::make('owner_user_id')->label(__('field.owner'))->relationship('owner', 'name')->searchable(),
        ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            TextColumn::make('id')->label(__('field.id'))->sortable(),
            TextColumn::make('contact_type')->label(__('field.contact_type'))->badge()
                ->color(fn (?ContactType $state): string => BadgePalette::audience($state?->value)),
